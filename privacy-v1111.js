      ...
      <div class="v1111-privacy-backdrop" id="v1111Privacy" aria-hidden="true">
        <section class="v1111-privacy-card" role="dialog" aria-modal="true" aria-labelledby="v1111PrivacyTitle">
          ...
          <section class="v1111-network-box">
            ...
            <p><strong>Cloud Brain:</strong> ${cloudConfigured&&cloudConsented?(window.KitsuneRouter?.consented()?"Облачный разговор и голос разрешены взрослым. Минимальный текст текущего вопроса и озвучиваемого ответа обрабатывается Cloudflare и Alibaba. Сервер приложения не сохраняет диалоги. Политики хранения провайдеров применяются отдельно.":"Разрешена только техническая проверка. Для разговора и голоса нужно отдельное согласие взрослого."):"Выключен."} История, Mastery, задания, фото, raw-аудио и содержимое локального хранилища не передаются в облачный чат. Whisper распознаёт микрофон локально. Автоматические фильтры уменьшают риск передачи личных данных, но не гарантируют абсолютную защиту.</p>
          </section>
