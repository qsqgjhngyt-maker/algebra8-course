      ...
      <div class="v1111-privacy-backdrop" id="v1111Privacy" aria-hidden="true">
        <section class="v1111-privacy-card" role="dialog" aria-modal="true" aria-labelledby="v1111PrivacyTitle">
          ...
          <section class="v1111-network-box">
            ...
            <p><strong>Cloud Brain:</strong> ${cloudConfigured?(cloudConsented?"разрешён взрослым на этом устройстве. На Stage 1 Cloudflare кратковременно обрабатывает только фиксированную техническую фразу и короткий ответ Qwen; они не сохраняются и не попадают в журналы приложения.":"настроен, но выключен на этом устройстве."):"ещё не настроен и не используется."} Текст ребёнка, raw-аудио, Mastery, история ошибок, ДЗ, фото и содержимое локального хранилища на Stage 1 не отправляются.</p>
          </section>
