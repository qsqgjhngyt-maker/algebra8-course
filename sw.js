const CACHE="algebra8-v2.3.0-beta.2.1";
const NEURAL_CACHE="algebra8-ai-runtime-v1";
const RELEASE="2.3.0-beta.2.1";
const ASSETS=[
  "./index.html?v=2.3.0-beta.2.1",
  ...
  "./intelligence-router-v230.js?v=2.3.0-beta.2.1",
  "./character-voice-v230.js?v=2.3.0-beta.2.1",
  "./version.json?v=2.3.0-beta.2.1"
];
...
self.addEventListener("install",e=>{
  /* v2.3.0-beta.2.1: cache every same-origin release asset independently.
