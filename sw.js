const CACHE="algebra8-v2.3.0-beta.2.2";
const NEURAL_CACHE="algebra8-ai-runtime-v1";
const RELEASE="2.3.0-beta.2.2";
const ASSETS=[
  "./index.html?v=2.3.0-beta.2.2",
  ...
  "./intelligence-router-v230.js?v=2.3.0-beta.2.2",
  "./character-voice-v230.js?v=2.3.0-beta.2.2",
  "./version.json?v=2.3.0-beta.2.2"
];
...
self.addEventListener("install",e=>{
  /* v2.3.0-beta.2.2: cache every same-origin release asset independently.
