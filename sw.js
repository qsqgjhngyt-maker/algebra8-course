const CACHE="algebra8-v2.2.0";
const NEURAL_CACHE="algebra8-ai-runtime-v1";
const RELEASE="2.2.0";
const ASSETS=[
  "./","./index.html?v=2.2.0","./styles.css?v=2.2.0","./app.js?v=2.2.0","./chapter1-v02.js?v=2.2.0","./course-v1.js?v=2.2.0",
  "./manifest.json?v=2.2.0","./assets/icon-192.png","./assets/icon-512.png","./assets/icon-maskable-192.png","./assets/icon-maskable-512.png","./assets/apple-touch-icon-180.png","./assets/favicon-64.png",
  ...
  "./coach-v12.js?v=2.2.0","./pedagogy-v12.js?v=2.2.0","./mastery-data-v13.js?v=2.2.0","./mastery-v13.js?v=2.2.0",
  "./design-v14.js?v=2.2.0","./learning-fx-v142.js?v=2.2.0","./live-assistant-v15.js?v=2.2.0",
  "./tutor-lite-v16.js?v=2.2.0","./tutor-smart-v173.js?v=2.2.0","./neural-voice-v17.js?v=2.2.0","./kitsune-brain-v18.js?v=2.2.0","./kitsune-voice-v19.js?v=2.2.0","./whisper-worker-v1114.js?v=2.2.0","./whisper-worker-v1116.js?v=2.2.0","./kitsune-live-v110.js?v=2.2.0","./privacy-v1111.js?v=2.2.0","./security-bootstrap-v1111.js?v=2.2.0","./pwa-update.js?v=2.2.0","./math-engine-v130.js?v=2.2.0","./math-lab-v130.js?v=2.2.0","./math-worker-v130.js?v=2.2.0","./performance-manager-v150.js?v=2.2.0","./learning-intelligence-v150.js?v=2.2.0","./course-search-v200.js?v=2.2.0","./offline-center-v200.js?v=2.2.0","./app-kernel-v200.js?v=2.2.0","./camera-import-v210.js?v=2.2.0","./auto-setup-v210.js?v=2.2.0","./mastery-score-v220.js?v=2.2.0","./reliability-center-v220.js?v=2.2.0","./student-experience-v220.js?v=2.2.0","./version.json?v=2.2.0"
];
...
self.addEventListener("install",e=>{
  /* v2.2.0 FINAL: cache every same-origin release asset independently.
