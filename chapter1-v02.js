...
function ch1RecordMistake(lesson,question,answer){state.mistakes.push({lesson,question,answer,ts:Date.now()});state.mistakes=state.mistakes.slice(-80);try{window.KitsuneLearning?.recordError?.({topicId:lesson,question,student:answer})}catch(e){}}
