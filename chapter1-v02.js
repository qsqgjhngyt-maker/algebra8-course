...
go=function(view){if(view==="home")renderHome();if(view==="course")renderCourse();if(view==="trainer")renderTrainer();if(view==="chapterfinal")renderChapterFinal("test");if(view==="mistakes")renderMistakes();if(view==="progress")renderProgress()};
