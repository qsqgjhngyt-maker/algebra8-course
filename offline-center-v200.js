...
/* =====================================================================
   Kitsune Offline & AI Center v2.2.1
    ...
    return `
      ...
      <section class="ko-actions glass-panel">
        <div>
          ...
          <p>В v2.2.1 Kitsune сама подготавливает Brain, Whisper, голос и OCR в фоне, когда есть сеть и достаточно места. Ребёнку не нужно заходить в настройки. Кнопки ниже оставлены как диагностика и ручной повтор для взрослого.</p>
        </div>
